...
Next: rollout step 4 — LLDAP → Authelia → everything gated behind it
(step 3, proving the Helm+Argo CD loop, was effectively covered by doing
step 2 for real). Old Traefik/Authelia SSO rollout history archived to
`archived/migration_plan.md`.
